...
from config import (ACCESS_TOKEN_EXPIRE_SECONDS, PASSWORD_AUTH, SECRET_KEY,
                    SECURITY_ALGORITHM, USERNAME_AUTH)
...
def validate_token(
    ...
    try:
        payload = jwt.decode(
            credentials.credentials, SECRET_KEY, algorithms=[SECURITY_ALGORITHM]
        )
