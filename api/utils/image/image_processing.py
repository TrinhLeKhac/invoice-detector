...
def processing_image_full(image, border=5, model=False):
    ...
    if model:
        ...
        table_information_by_cropped = pipeline_extract_information(
            table_roi_by_cropped, border=border
        )
        table_information_by_extracted = pipeline_extract_information(
            table_roi_by_extracted, border=border
        )
        ...
        table_information = merge_outputs(
            table_information_by_cropped, table_information_by_extracted
        )
